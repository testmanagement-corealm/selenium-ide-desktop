...
const PlaybackControls: React.FC = () => {
  ...
  return (
    <Paper className="flex flex-col flex-initial width-100 window-drag">
      ...
      <div className="flex flex-row flex-initial no-window-drag" style={{'height':'40px'}}>
        <Paper
        ...
        >
          ...
          <div style={{"border": '1px solid #9e9e9e',"borderRadius":'4px','width':'113px','height':'29px','display':'flex','justifyContent':'right','marginRight':'10px'}}>
          <TestControls/>
          </div>
