    ...
    const [languageMap, setLanguageMap] = useState<any>({
        ...
        commandMap: {
            acceptAlert: {
                name: 'accept alert',
                description:
                    'Affects a currently showing alert. This \n        command instructs Selenium to accept it.',
            },
            acceptConfirmation: {
                name: 'accept confirmation',
                description:
                    'Affects a currently showing confirmation alert. This \n        command instructs Selenium to accept it.',
            },
            addSelection: {
                name: 'add selection',
                description:
            ...
            storeElementCount: {
                ...
                description:
                    'Gets the number of nodes that match the specified locator \n        (e.g. "xpath=//table" would give the number of tables).',
                target: {
                    name: 'locator',
                    description: 'An element locator',
                },
